# Azure DevOps Pipeline Definitions YAML

azure-devops-pipeline-definitions-yaml.md
...
```
azure-pipelines.yml: Mapping values are not allowed in this context.
```

Check indentation in YAML.


https://amanagrawal.blog/2018/12/30/building-ci-cd-pipeline-with-azuredevops-octopus-and-cake-scripting/
